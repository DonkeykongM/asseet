  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50 pt-20 pb-16 sm:pt-24 sm:pb-20">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 left-20 h-48 w-48 rounded-full bg-indigo-100/40 blur-2xl"></div>
      </div>
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-gray-600 sm:text-xl lg:text-2xl mb-8 max-w-3xl mx-auto">
            Valuation only needs a click. Real-time analysis for effortless valuation of jewelry, 
            art and collectibles. No input, no errors!
          </p>
          ...
          <form onSubmit={handleSubmit} className="mb-12 max-w-3xl mx-auto">
            <div className="relative bg-white rounded-2xl border-2 border-blue-200 shadow-lg hover:shadow-xl transition-all duration-300 focus-within:border-blue-400 focus-within:ring-4 focus-within:ring-blue-100">
              <div className="flex items-center p-4 sm:p-6">
                ...
                <input
                  type="text"
                  placeholder="Describe your item, or send a picture of the valuable..."
                  value={inputValue}
                ...
                <div className="ml-4 flex items-center space-x-2">
                  ...
                  <Button 
                    ...
                    className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 px-6 disabled:opacity-50"
                  >
                    {isSubmitting ? (
              ...
              {submitStatus === 'success' && (
                <div className="px-6 pb-4">
                  <div className="flex items-center space-x-2 text-sm text-green-600">
                    ...
                    <span>Successfully submitted! We'll analyze your item and get back to you.</span>
                  </div>
                </div>
              )}
          ...
          <div className="mt-16 flex flex-col items-center space-y-4 sm:flex-row sm:space-y-0 sm:space-x-8 sm:justify-center">
            ...
            <div className="flex items-center space-x-2 text-gray-500">
              ...
              <span className="text-sm font-medium">50K+ items valued</span>
            </div>
          </div>
        </div>
      </div>
